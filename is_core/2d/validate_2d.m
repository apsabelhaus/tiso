...
elseif n ~= size(y, 1)
    error('Error: the C matrix and the y vector (node positions in z) have a different number of nodes. Cannot continue.');
...
elseif n ~= size(py, 1)
    error('Error: the C matrix and the py vector (node external rxn. forces in z) have a different number of nodes. Cannot continue.');
